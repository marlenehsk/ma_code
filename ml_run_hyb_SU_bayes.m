function ml_run_hyb_SU_bayes(nname)
...
ml_hyb_SU_bayes.names = {'wm', 'wp', 'wmult', 'lambda', 'gamma', 'modelfit', 'LLE', 'bic'}; 
...
for i = 1:numel(vp)
        ...
        ml_hyb_SU_bayes.params(i,:) = [params, betas, modelfit, bic, aic];
        toc
        
end 

    save('./ml_hyb_SU_bayes', 'ml_hyb_SU_bayes');
