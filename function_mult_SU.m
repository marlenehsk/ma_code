function [fitparams, modelfit] = function_mult_SU(data, num_it)

% function script for mult SU model (both distortions)

% first: set up fmincon

lb = [0 0 0]; 
ub = [60 3 3]; % parameters are wmult, lamda and gamma
