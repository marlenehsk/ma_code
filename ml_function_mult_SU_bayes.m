% function ml_function_mult_SU_bayes

function [fitparams, modelfit] = ml_function_mult_SU_bayes(data, num_it, subpls)

lb = [0 0 0]; 
ub = [60 3 3]; % parameters are wmult, lambda and gamma
...
for i = 1:num_it
    ...
    [fitparams_1, modelfit_1] = fmincon(@SU_model_mult, x0, A, b, Aeq, beq, lb, ub, [], options);
...
function loglikehood = SU_model_mult(params)
...
% turn objective into subjective values, here both distortions
