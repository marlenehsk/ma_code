...
function run_hyb_EV_stable(nname)
...
hyb_EV_stable.names = {'wm', 'wp', 'wmult', 'beta_m', 'beta_p', 'beta_mult', 'LLE', 'bic', 'aic'}; 
...
for i = 1:numel(vp)
        ...
        hyb_EV_stable.params(i,:) = [params, betas, modelfit, bic, aic]; 
        toc 
end 

    save('./hyb_EV_stable', 'hyb_EV_stable');
