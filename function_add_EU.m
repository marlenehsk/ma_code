function [fitparams, betas, modelfit] = function_add_EU(data, num_it)

% function script for add EU model (magnitude, but no probability
% distortion)

% first: set up fmincon and betas 

lb = [0 0 0]; 
ub = [60 60 3]; % parameters: wm, wp and lambda
